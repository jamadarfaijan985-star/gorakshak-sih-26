...
def generate():
    ...
    print("\n=== GoRakshak Synthetic Generator V2.4 ===\n")
    ...
    out_csv = OUT_ROOT / "gorakshak_synthetic_longitudinal_v4.csv"
    out_manifest = OUT_ROOT / "synthetic_animal_manifest_v4.csv"
    out_validation = OUT_ROOT / "synthetic_validation_report_v4.csv"
    out_report = OUT_ROOT / "synthetic_calibration_report_v4.json"
